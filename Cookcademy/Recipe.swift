...
struct Recipe {
  ...
  var directions: [Direction]
    ...
    init(mainInformation: MainInformation, ingredients:[Ingredient], directions:[Direction]) {
      ...
      init() {
          self.init(mainInformation: MainInformation(name: "", description: "", author: "", category: MainInformation.Category.breakfast.rawValue),
                  ingredients: [],
                  directions: [])
      }
}
...
extension Recipe {
    static let testRecipes: [Recipe] = [
        Recipe(mainInformation: MainInformation(name: "Dad's Mashed Potatoes",
                                                ...
                                                author: "Josh",
                                                category: MainInformation.Category.dinner.rawValue),
               ingredients: [
        ...
        Recipe(mainInformation: MainInformation(name: "Beet and Apple Salad",
                                                ...
                                                category: MainInformation.Category.lunch.rawValue),
               ingredients: [
        ...
        Recipe(mainInformation: MainInformation(name: "Best Brownies Ever",
                                                ...
                                                author: "Pam Broda",
                                                category: MainInformation.Category.dessert.rawValue),
               ingredients: [
        ...
        Recipe(mainInformation: MainInformation(name: "Omelet and Greens",
                                                ...
                                                category: MainInformation.Category.breakfast.rawValue),
               ingredients: [
